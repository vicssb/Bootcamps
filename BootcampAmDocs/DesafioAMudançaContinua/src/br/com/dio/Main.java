 ...
 * anterior só informava uma saudação, ele pediu que transformasse o grau do Sol/Lua
 * em HH:MM:SS. Então caso aceite: dado um grau relativo a posição do Sol/Lua, refaça o
 * sistema só que agora além da saudação de cada período do dia, informe exatamente as horas,
 * os minutos e segundos.
 * A entrada contem um pontos flutuantes M (0 ≥ M < 360) representando a posição, em graus,
 * do Sol/Lua em relação a terra. Como eles andam em constante movimento seu programa
